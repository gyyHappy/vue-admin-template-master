<template>
  <div class="app-container">
    ...
    <el-table :data="list" element-loading-text="数据加载中" border fit highlight-current-row>
      ...
      <el-table-column prop="title" label="课程名称" width="310" align="center" />

      <el-table-column label="课程状态" width="127" align="center" >
      ...
      <el-table-column prop="gmtCreate" label="添加时间" width="250" align="center" />

      <el-table-column prop="viewCount" label="浏览数量" width="104" align="center"  />
...
export default {
  ...
  methods: {
    ...
    getList(page = 1) {
      this.page = page;
      course
        .pageListCondition(this.page, this.limit, this.courseQuery)
        .then((response) => {
          //请求成功
          //response接口返回的数据
